...
class HexUtil{
    ...
    static func encodeToString(hexBytes: [UInt8]) -> String {
        var outString = ""
        for val in hexBytes {
    ...
    static func trimString(theString: String) -> String? {
   ...
   static func decode(source: [UInt8]) throws -> [UInt8] {
   ...
   static func fromHexChar(hexChar: UInt8) -> UInt8? {
    ...
    internal static func decodeString(hexString: String) throws -> [UInt8] {
